...
$is_installed = Futusign_OverlayClock::is_plugin_installed( 'futusign' );
$target = false;
...
<div class="notice error is-dismissible">
	<p><strong>futusign Overlay Clock</strong> <?php esc_html_e('depends on the last version of futusign to work!', 'futusign_overlayclock' ); ?></p>
